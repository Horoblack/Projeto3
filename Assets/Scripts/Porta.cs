...
public class Porta : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (Jogador != null)
        {
            listaDeCartoes = Jogador.GetComponent<Cards>();
        }
    ...
    void Update()
    {
        if (Jogador != null && listaDeCartoes != null)
        {
            ControlarPorta();
            GirarObjeto();
        }
    ...
    void ChecarSeTemAChave()
    {
        ...
        for (int x = 0; x < listaDeCartoes.CartoesDoJogador.Count; x++)
        {
            if (listaDeCartoes.CartoesDoJogador[x] == IDPorta)
            {
                temAChave = true;
            }
        }
